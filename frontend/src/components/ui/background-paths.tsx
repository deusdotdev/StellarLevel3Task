...
export function BackgroundPaths({
  ...
  return (
    <div className="relative flex min-h-[calc(100svh-2.75rem)] w-full items-center justify-center overflow-hidden bg-ink">
      <div className="absolute inset-0">
        <FloatingPaths position={1} />
        <FloatingPaths position={-1} />
      </div>

      <div className="relative z-10 container mx-auto px-4 pt-28 pb-16 text-center md:px-6">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
